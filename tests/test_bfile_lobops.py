...
from oracle.tns import encode_dictionary_lobops
from oracle.tns_consts import (
    TNS_LOB_OP_FILE_OPEN, TNS_LOB_OP_FILE_CLOSE, TNS_LOB_OP_READ)
...
class BfileLobopsEncode(unittest.TestCase):
    ...
    def test_file_close(self):
        ...
        self.assertEqual(
            Out.hex(),
            "0360080101380000000000000002020000000000000000000000000036"
            + LOC.hex())
    ...
    def test_read_prefixed(self):
        ...
        Out = encode_dictionary_lobops(
            {'seq': 7, 'operation': TNS_LOB_OP_READ, 'locator': LOC,
             'locator_prefixed': True, 'amount': 0xFFFFFFFF})
        self.assertEqual(
            Out.hex(),
